...
<body>
    ...
    <main>
        ...
        <div class="programmeu">
            ...
            <div class="container2">
                ...
                <div class="item2">
                    ...
                    <span class="flexboxtxt4">Traversée libre de l’Espagne jusqu'à Algeciras pour les centaines de 4L, où le férie nous attend pour la traversée.</span>
                </div>
                <div class="item2">
                    <span class="flexboxtxt3"></br>TANGER :</br></span>
                    <span class="flexboxtxt4">Etape liaison à Tanger ou les 4L débarquent au Maroc après la traversée du détroit de Gibraltar. Découverte des premiers paysages montagneux puis désertiques ou les Trophistes entrent dans le vif du sujet !</span>
                </div>
                <div class="item2">
                    <span class="flexboxtxt3"></br>BOULAJOUL :</br></span>
                    <span class="flexboxtxt4">La compétition sportive est lancée. Guidées par les boussoles, les 4L filent vers les portes du Sahara à travers des paysages typiques faits d’oueds, de pistes et de petits pièges sablonneux.</span>
                </div>
                <div class="item2">
                    <span class="flexboxtxt3"></br>MERZOUGA :</br></span>
                    <span class="flexboxtxt4">Remise des fournitures solaires et sportives à l'association "Enfants du Désert" en faveur des enfants défavorisés dans cette petite ville du sud du Sahara près de la frontière Algerienne.</span>
                </div>
                <div class="item2">
                    <span class="flexboxtxt3"></br>MARRAKECH :</br></span>
                    <span class="flexboxtxt4">Après une journée libre dans Marrakech, rendez-vous est pris chez Ali où se tient la grande soirée de clôture du 4L Trophy. Remise des prix aux grands vainqueurs de la compétition, dîner traditionnel, avant le grand retour en France.</span>
                </div>
            </div>
        ...
        <FORM method="POST" action="formulaire.php">
            <INPUT type="text" name="name" size=30 placeholder="Nom" required></br>
            <INPUT type="text" name="firstname" size=30 placeholder="Prénom" required><br>
            <INPUT type="text" name="email" size=30 placeholder="E-Mail" required><br>
            <INPUT type="text" name="tel" size=30 placeholder="Numéro de téléphone (Facultatif)"><br>
